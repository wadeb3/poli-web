...
export const TYPE = {
  masthead: { fontFamily: FONT.display, fontSize: 28, lineHeight: 1.2,  fontWeight: 600, letterSpacing: "-0.01em" },
  hero:     { fontFamily: FONT.display, fontSize: 22, lineHeight: 1.25, fontWeight: 600, letterSpacing: "-0.005em" },
  h2:       { fontFamily: FONT.display, fontSize: 18, lineHeight: 1.35, fontWeight: 600 },
  h3:       { fontFamily: FONT.display, fontSize: 15, lineHeight: 1.4,  fontWeight: 600 },
  stat:     { fontFamily: FONT.display, fontSize: 32, lineHeight: 1,    fontWeight: 600, fontVariantNumeric: "tabular-nums" },
